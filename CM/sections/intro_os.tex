...
\begin{frame}{Exemple : abstraction d'un disque dur}
  \begin{itemize}
    ...
    \begin{itemize}
      {\footnotesize
      \item première couche d'abstraction : premier couche d'abstraction: disk driver
...
\begin{frame}{Histoire de Linux (années 1980--aujourd'hui)}
  \begin{itemize}
    ...
    \item Avantages d'un système d'exploitation open source (libre, et pas juste gratuit)
    \begin{itemize}
      {\footnotesize
