...
\begin{frame}{L'ère de l'électronique}
  \begin{itemize}
    ...
    \begin{itemize}
      {\footnotesize
      \item machine à tubes à vide, développé par John Mauchly et J. Presper Eckert
      \item premier ordinateur électronique généraliste (Turing-complet)
      \item utilisation militaire (calculs balistiques, simulations bombe à hydrogène)
...
\begin{frame}{L'ère de l'électronique}
  \begin{itemize}
    ...
    \begin{itemize}
      {\footnotesize
      \item machine à tubes à vide (Turing-complet)
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item intégrer des milliers (puis des millions) de composants sur une puce
