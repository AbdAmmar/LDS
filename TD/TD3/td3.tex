...
\begin{enumerate}
    ...
    \item Placez-vous dans le répertoire \texttt{TD3} et créez un sous-répertoire nommé \texttt{Q2}.

    % ---

    \item Placez-vous dans le répertoire \texttt{Q2} et créez un fichier nommé \texttt{game.sh}.
