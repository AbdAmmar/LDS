...
\begin{itemize}
    ...
    \prompt\ Rep="TD/TD4/data/vrac\_rh.tar.gz"
    ...
    \prompt\ \tcomment{Vérification de fichiers}
...
\begin{itemize}
    ...
    À chaque étape, affichez la valeur actuelle de $N$ et comptabilisez le nombre d'itérations effectuées dans une variable dédiée.

    Voici un exemple de la \textbf{sortie} attendue :
    \begin{terminal}
