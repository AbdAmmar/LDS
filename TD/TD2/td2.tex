...
\begin{itemize}
    ...
    La répétition se fait avec \texttt{\textbackslash\{m\textbackslash\}} ou \texttt{\textbackslash\{m,n\textbackslash\}}.

    Avec \texttt{grep -E},  on active les ``regex étendues''. Ici, \texttt{\{ \}} sont directement des quantificateurs, \emph{sans antislash}.
    \begin{itemize}
