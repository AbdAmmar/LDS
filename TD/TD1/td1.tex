...
\title{TD1 - Découverte du système Linux}
...
Ce TD a pour objectif de découvrir le système Linux à travers les commandes de base
permettant d'explorer :
\begin{itemize}
    \item la machine (processeur, mémoire, disque),
    \item le système (noyau, distribution),
\end{itemize}
