...
\end{terminal}
    \item Entrez dans \texttt{TD2} et vérifiez votre position.
\begin{terminal}
\prompt\ \shcmd{cd} TD2

\prompt\ \shcmd{pwd}
\end{terminal}
    \item Créez un répertoire \texttt{TD2-bis} et placez-vous dedans.
    ...
    \end{itemize}
    \item Entrez dans \texttt{TD2-bis-1} et créez un répertoire nommé \texttt{test}.
    \item Revenez en arrière puis entrez dans \texttt{TD2-bis-3}.
\begin{terminal}
...
\end{terminal}
    ...
    \texttt{TD2-bis-} en une ou plusieurs commandes.
\begin{terminal}
\prompt\ \shcmd{rm} -r TD2/TD2-bis/TD2-bis-1

\prompt\ \shcmd{rm} -r TD2/TD2-bis/TD2-bis-2

\prompt\ \shcmd{rm} -r TD2/TD2-bis/TD2-bis-3

\prompt\ \tcomment{ou bien}

\prompt\ \shcmd{rm} -r TD2/TD2-bis/TD2-bis-*
\end{terminal}
\end{enumerate}
...
\begin{enumerate}
    \item Placez-vous dans le répertoire \texttt{TD2} et créez un fichier 
...
\end{terminal}
    \item Ouvrez maintenant le fichier \texttt{notes.txt} avec l'éditeur de texte
          \texttt{gedit}.
\begin{terminal}
...
\rsubsection{} 
Déterminez les informations suivante à l'aide de commandes Linux :
\begin{itemize}
