...
\begin{itemize}
    ...
    \end{terminal}
    \begin{warningbox}
    En Bash, le code de sortie (\texttt{\$?}) suit la convention Unix : 0 indique un succès (\texttt{true}) et toute valeur non-nulle indique un échec (\texttt{false}). Cette convention est opposée à celle des langages de programmation où 0 évalue à \texttt{false} et 1 à \texttt{true} dans un contexte booléen.
    \end{warningbox}
\end{itemize}
